...
def parse_opt():
    ...
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[1088, 1920], help='image (h, w)')
    ...
    parser.add_argument('--conf-thres', type=float, default=0.2, help='TF.js NMS: confidence threshold')
